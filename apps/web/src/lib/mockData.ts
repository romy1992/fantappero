...
export const mockLeagues: LeagueSummary[] = [
  {
    ...
    description: "MVP con draft semplificato, rose complete e formazione a step.",
    inviteCode: "FANTA26",
    teamsCount: 8,
  ...
  },
  {
    ...
    description: "Lega privata per testare lock giocatore e risultati base.",
    inviteCode: "WEEK11",
    teamsCount: 6,
    currentRound: "Draft",
    status: "Draft aperto"
...
export const mockRoster: RosterPlayer[] = [
  ...
  { id: "p-7", firstName: "Nicolò", lastName: "Serra", role: "defender", club: "Firenze Viola", value: 6, locksAt: "2026-08-24T21:00:00Z" },
...
export const mockAvailablePlayers: RosterPlayer[] = [
  { id: "p-17", firstName: "Samuele", lastName: "Bassi", role: "goalkeeper", club: "Bologna Nord", value: 5, locksAt: "2026-08-23T16:30:00Z" },
  { id: "p-18", firstName: "Filippo", lastName: "Mancini", role: "defender", club: "Como Lake", value: 6, locksAt: "2026-08-24T18:45:00Z" },
  { id: "p-19", firstName: "Cristian", lastName: "Rossi", role: "midfielder", club: "Parma Ducale", value: 10, locksAt: "2026-08-24T21:00:00Z" },
  { id: "p-20", firstName: "Leonardo", lastName: "Sarti", role: "forward", club: "Cagliari Sud", value: 12, locksAt: "2026-08-23T18:45:00Z" }
];
